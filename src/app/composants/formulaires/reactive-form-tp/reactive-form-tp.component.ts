...
@Component({
  selector: 'app-reactive-form-tp',
  templateUrl: './reactive-form-tp.component.html',
  styleUrls: ['./reactive-form-tp.component.css']
})
export class ReactiveFormTpComponent implements OnInit {
